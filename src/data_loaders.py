...
__all__ = ['CIFAR10DataLoader', 'ImageNetDataLoader', 'CIFAR100DataLoader', 'SVHNDataLoader', 'GTSRBDataLoader']
...
class GTSRBDataLoader(DataLoader):
    def __init__(self, data_dir, split='train', image_size=224, batch_size=16, num_workers=8):
        ...
        self.dataset = GTSRB(root=data_dir, split=split, transform=transform, download=True)
...
class SVHNDataLoader(DataLoader):
    def __init__(self, data_dir, split='train', image_size=224, batch_size=16, num_workers=8):
        ...
        self.dataset = SVHN(root=data_dir, split=split, transform=transform, download=True)
